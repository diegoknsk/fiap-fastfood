...
namespace FastFood.Domain.Entities.OrderManagement
{
    public class Product
    {
        ...
        public ICollection<ProductBaseIngredient> Ingredients { get; private set; } = new List<ProductBaseIngredient>();
        ...
        public Product(Guid? id, string name, EnumProductCategory category, decimal price, ICollection<ProductBaseIngredient>? ingredients = null, ImageProduct? image = null)
        {
            Id = id ?? Guid.NewGuid();
        ...
        public void AddProduct(string name, EnumProductCategory category, decimal price,
            ICollection<ProductBaseIngredient>? ingredients = null, ImageProduct? image = null)
        {
            Id = Guid.NewGuid();
            SetProperties(name, category, price, ingredients, image);
        }

        private void SetProperties(string? name, EnumProductCategory category, decimal price, ICollection<ProductBaseIngredient>? ingredients, ImageProduct? image)
        {
            ...
            Category = category;
            Price = price;
            Ingredients = ingredients ?? new List<ProductBaseIngredient>();
            Image = image;
        }
