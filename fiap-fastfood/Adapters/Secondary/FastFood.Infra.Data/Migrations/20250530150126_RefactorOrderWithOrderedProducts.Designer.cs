...
namespace FastFood.Infra.Data.Migrations
{
    ...
    [Migration("20250530150126_RefactorOrderWithOrderedProducts")]
    partial class RefactorOrderWithOrderedProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FastFood.Domain.Entities.OrderManagement.OrderedProduct", b =>
                {
                    ...
                    b.Property<Guid?>("OrderId3")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("OrderId4")
                        .HasColumnType("char(36)");
